...
def main():
    ...
    tree = input("Type 3 for Binary search using B-Tree.\nType 4 to exit program.\n")
    ...
    if tree == '1':
        ...
        file = input("Please type the name of your file: ")
        print("Please wait while the B-Tree is generated.")
        start_time = time.time()
        b_tree = create_btree(file)
        end_time = time.time()
        print("--- %s seconds ---" % (end_time - start_time))
        keep_going = True
        while keep_going:
            print("Please choose an option to perform:")
            print("   1. Print B-Tree.")
            print("   2. Get the number of anagrams from a word.")
            print("   3. Print all possible anagrams from a word.")
            print("   4. Get the word with the most possible anagrams in a file.")
            print("   5. Print B-Tree in tree mode.")
            answer = input()
            ...
            if answer == '1':
                ...
                word = input("Please type the word to search for anagrams: ")
                print(count_anagrams(word, b_tree))
            elif answer == '3':
                word = input("Please type the word to search for anagrams: ")
                print_anagrams(word, b_tree)
            elif answer == '4':
                file = input("Please type the name of the file: ")
                highest_anagrams = most_anagrams(file, b_tree)
                print("The word with the most anagrams is:", highest_anagrams)
            elif answer == '5':
                b_tree.print_d('')
            else:
